...
<footer className=" bg-white rounded-lg mt-20 dark:bg-gray-900 m-4 w-full">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400 mr-8">© 2023 <a href="https://google.com/" className="hover:underline">Cazz AI</a>. All Rights Reserved.</span>
    </div>
</footer>
      </div>
