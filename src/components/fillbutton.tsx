const GradientFillButton = () => {
  return (
    <div className="group/button relative overflow-hidden rounded-3xl border-2 border-white bg-gradient-to-r from-pink-600 to-blue-500 px-4 py-1 text-lg font-medium text-white transition-all duration-150 hover:border-blue-500 hover:text-blue-500 active:scale-95">
